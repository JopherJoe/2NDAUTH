...
router.post('/', isLoggedIn, async (req, res) => {
  try {
    ...
    const { course, firstname, lastname, email, contact_no, age, birthdate, gender, mothername, fathername, guardian_contact, address, elementaryschool, juniorschool, seniorschool } = req.body;
